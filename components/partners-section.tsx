  ...
  return (
    ...
    >
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <h2
            className={`text-4xl md:text-5xl font-bold text-foreground mt-4 text-balance transition-all duration-700 delay-200 ${
              inView
                ? "opacity-100 translate-y-0"
                : "opacity-0 translate-y-10"
            }`}
    ...
    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-3">
      {partners.map((partner) => (
        ...
        {/* Stats Row */}
        <div
          className={`grid grid-cols-3 gap-8 mt-20 pt-12 border-t border-border transition-all duration-1000 delay-500 ${
        ...
        >
          ...
          <div className="text-center">
            ...
            <div className="text-muted-foreground text-sm mt-1">
              {t("partnersSection.stats.support")}
            </div>
          </div>
        </div>
      </div>
