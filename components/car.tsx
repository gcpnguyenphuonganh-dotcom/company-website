      ...
      <div className="max-w-[1700px] mx-auto grid grid-cols-1 md:grid-cols-[5fr_7fr] min-h-[480px]">
        ...
        <div className="flex items-center py-[clamp(40px,6vw,96px)] px-[clamp(24px,5vw,80px)]">
          <div className="w-full">
            ...
            <h2 className="text-[clamp(26px,4vw,42px)] font-extrabold text-gray-900
                            leading-[1.15] tracking-[-0.02em] m-0 mb-[clamp(12px,1.5vw,20px)]">
              {t("automotiveSection.titleLine1")}
              <br />
              <span className="text-[#013478]">{t("automotiveSection.titleLine2")}</span>
            </h2>

            <p className="text-[clamp(13px,1vw,14px)] leading-[1.85] text-gray-500
                           font-['DM_Sans',sans-serif] font-light mb-[clamp(16px,2vw,28px)]">
            ...
            <div className="flex flex-col">
              {features.map(({ icon: Icon, key }, i) => (
                ...
                >
                  ...
                  <span className="text-sm md:text-[clamp(12px,0.9vw,13.5px)] font-semibold text-gray-800
