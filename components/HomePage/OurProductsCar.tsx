              ...
              {features.map(({ icon: Icon, key }, i) => (
                <div
                  ...
                  className="flex items-center gap-3
                             py-3 md:py-[clamp(10px,1.2vw,14px)] border-t border-gray-200"
                >
                  ...
                  <span className="text-sm md:text-[clamp(12px,0.9vw,16px)] font-semibold text-gray-800 font-['DM_Sans',sans-serif]">
